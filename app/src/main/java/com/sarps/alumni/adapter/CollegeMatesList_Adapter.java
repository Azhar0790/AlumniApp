 ...
 */
public class CollegeMatesList_Adapter extends RecyclerView.Adapter<CollegeMatesList_Adapter.Viewholder> {

    Context context;
    ArrayList<Classmates_item> list;

    public CollegeMatesList_Adapter(Context context, ArrayList<Classmates_item> list) {
